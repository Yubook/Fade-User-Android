...
import com.youbook.fade.databinding.ActivityAddReviewBinding
...
import com.youbook.fade.utils.Utils.compressImage
...
class AddReviewActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun showSingleImage(uri: Uri) {
        mCurrentPhotoPath = com.youbook.fade.utils.FileUtil.getPath(ToastUtil.context, uri)
