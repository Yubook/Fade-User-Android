...
import com.youbook.fade.databinding.ActivityProfileBinding
...
import com.youbook.fade.ui.get_location.GetLocationActivity
import com.youbook.fade.utils.*
import com.youbook.fade.utils.Utils.handleApiError
...
class ProfileActivity : AppCompatActivity(), View.OnClickListener {
            ...
            when (it) {
                is Resource.Success -> {
                    if (it.value.result != null) {
                        ...
                        if (isFirstTime.equals("YES")) {
                            val i = Intent(this@ProfileActivity, com.youbook.fade.MainActivity::class.java)
                            i.flags =
    ...
    private fun showSingleImage(uri: Uri) {
        mCurrentPhotoPath = com.youbook.fade.utils.FileUtil.getPath(context, uri)
