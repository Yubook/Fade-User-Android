...
import com.youbook.fade.databinding.ActivityCodeVerifyBinding
...
import com.youbook.fade.ui.profile.Result
...
import com.youbook.fade.extension.hideKeyboard
                        ...
                        if (it.value.result != null) {
                            if (it.value.result.role_id == 3) {
                                if (it.value.message!!.contains("User Not Found")) {
                                    ...
                                    var intent = Intent(this, com.youbook.fade.MainActivity::class.java)
                                    intent.flags =
